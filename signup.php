...
<label for="inputcontact">Role</label>
</div>    
 -->

 <div class="form-floating mb-3">
 <!--<label for="inputcontact">Choose a role:</label>-->
  <select class="form-control" id="contact" name="contact" type="text" placeholder="Role">
    <option value="Doctor">Doctor</option>
    <option value="Labratoriest">Labratories</option>
